...
<h1 style="text-align: center;color:#F73D93">QUẢN LÝ NGƯỜI DÙNG</h1>
<div style="margin-bottom: 20px">
    <a href="/btljava/admin/quanlyND/form_ND" > <i class="fa-solid fa-circle-plus" > </i> TẠO MỚI </a>
</div>
        ...
        <table class="table"style="text-align: center">
            ...
            <c:forEach items="${dsND}" var="c" >
                <tr style="font-size: 15px">
                    <c:if test="${c.userRole!='ROLE_ADMIN' && c.userRole!='ROLE_SUPERADMIN' }">
                        <c:if test="${c.active==true}">  
                            ...
                            <td>
                                <a class="btn btn-default"
                                   ...
                                   href="${pageContext.request.contextPath}/admin/quanlyND/nguoidung/delete/${c.idNguoiDung}">
